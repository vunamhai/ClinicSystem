...
public class Examination1 {
     ...
     */
    public Examination1(int examinationId, Reservation reservation, User doctor, String examinationDisgnosis, String examinationPrescription, Date examinationDate) {
