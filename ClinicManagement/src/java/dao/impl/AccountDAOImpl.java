    ...
    * a <code>java.util.List</code> object 
    ...
    public Account1 login(String username, String password) {
        ...
        try {
            ...
            // Get data
            preparedStatement = connecion.prepareStatement("select a.ID , a.UserName, a.Password, r.role_id from Accounts a join Account_Roles r on a.ID = r.role_id where UserName = ? "
