 ...
 * @author Admin
 */
public class AddNewPackageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ServicePackage sp = new ServicePackage(serviceName, service_examinationDuration, f);
        dAO.addPackageService(sp);
