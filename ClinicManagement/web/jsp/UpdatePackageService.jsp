<%-- 
    Document   : PackageService
    Created on : 14-07-2022, 23:14:05
    Author     : Admin
--%>
        ...
        <div class="modal-dialog modal-lg" id="editServiceModal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="../ClinicManagement/PackageManagementController?page=${page}">
                ...
                <p class="col-8"></p>
                <div class="row mb-6">
                    <label for="id" class="col-4 col-form-label">Mã gói dịch vụ</label>
                    <div class="col-4">
                        <input type="text" class="form-control" name="id" readonly
                               id="id" value="${services.packageId}" required maxlength="50"> 
                    </div>
                </div>
                <p class="col-8"></p>
                <div class="row mb-6">
