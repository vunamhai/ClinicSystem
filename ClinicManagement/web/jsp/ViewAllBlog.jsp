...
<html>
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script><title>Blog Management</title>
...
<!--                        <form class="form-inline" action="GetAllAccountController" method="GET">
                    ...
                    <table id="datatable" class="table table-striped table-bordered mx-auto" cellspacing="0" width="70%">
                        ...
                        <c:forEach items="${listBlog}" var="a">
                            <tr>
                                <td>${a.id}</td>
                                <td>${a.title}</td>
                                <td>${a.description}</td>
